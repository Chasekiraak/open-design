...
export const CODEX_SKILLS: readonly CodexSkill[] = [
  ...
  },
  {
    ...
    codexNote: '无 Codex 字样；`npx skills add` 跨 agent',
  ...
  },
  {
    ...
    codexNote: 'README: 可从 Codex session 运行',
  ...
  },
  {
    ...
    codexNote: 'agent-skills/codex/ 明确 Codex',
    social: '上游使用量 13,807 次',
    repo: 'MengTo/Skills',
  ...
  },
  {
    ...
    bundle: '内含 8 个模块：core / timeline / scrolltrigger / plugins / react / frameworks / performance / utils',
    codexNote: 'README 提 Codex ×5',
    social: 'YT AI LABS 109,460',
  ...
  },
  {
    ...
    bundle: '内含 3 个命令：find-animation-opportunities / improve-animations / review-animations',
    codexNote: '无 Codex 字样；跨 agent',
    social: 'X @emilkowalski 6,494♥',
    repo: 'emilkowalski/skills',
