...
> = {
  fr: homeFallbackCopy({
    ...
    faqSection: {
      ...
      titleMiddle: 'et',
      titleSuffix: 'l’alternative à code source disponible à Claude Design',
    },
    cta: {
  ...
  ru: homeFallbackCopy({
    railRight: 'Open Design — том 01 · выпуск № 26 · ODCL 1.0',
    ...
    heroLabel: 'Дизайн-студия с доступным исходным кодом',
    heroIssue: 'Кейс № 01 · локально / открыто / Земля',
    heroTitlePrefix: 'С доступным кодом',
    ...
    faqSection: {
      ...
      titleMiddle: 'и',
      titleSuffix: 'альтернативу Claude Design с доступным исходным кодом',
    },
    cta: {
  ...
  es: homeFallbackCopy({
    railRight: 'Open Design — vol. 01 · número 26 · ODCL 1.0',
    ...
    heroLabel: 'Estudio de diseño con código fuente disponible',
    heroIssue: 'Caso Nº 01 · local / abierto / Tierra',
    heroTitlePrefix: 'Claude Design',
    heroTitleEmphasis: 'con código fuente disponible',
    ...
    faqSection: {
      ...
      titleMiddle: 'y',
      titleSuffix: 'la alternativa a Claude Design con código fuente disponible',
    },
    cta: {
  ...
  'pt-br': homeFallbackCopy({
    railRight: 'Open Design — vol. 01 · edição nº 26 · ODCL 1.0',
    railLeft: 'Skills · sistemas · agentes · BYOK · local-first',
    discordAria: 'Entrar no Discord do Open Design',
    joinDiscord: 'Entrar no Discord',
    heroLabel: 'Estúdio de design com código-fonte disponível',
    heroIssue: 'Caso Nº 01 · local / aberto / Terra',
    heroTitlePrefix: 'Claude Design',
    heroTitleEmphasis: 'com código-fonte disponível',
    heroTitleMiddle: 'no',
    ...
    faqSection: {
      ...
      titleMiddle: 'e',
      titleSuffix: 'a alternativa ao Claude Design com código-fonte disponível',
    },
    cta: {
  ...
  it: homeFallbackCopy({
    ...
    faqSection: {
      ...
      titleMiddle: 'e',
      titleSuffix: 'l’alternativa a Claude Design a codice sorgente disponibile',
    },
    cta: {
  ...
  vi: homeFallbackCopy({
    ...
    faqSection: {
      ...
      titleMiddle: 'và',
      titleSuffix: 'lựa chọn có mã nguồn khả dụng thay Claude Design',
    },
    cta: {
  ...
  pl: homeFallbackCopy({
    railRight: 'Open Design — tom 01 · wydanie nr 26 · ODCL 1.0',
    ...
    heroLabel: 'Studio designu z dostępnym kodem źródłowym',
    heroIssue: 'Sprawa Nº 01 · lokalnie / otwarte / Ziemia',
    heroTitlePrefix: 'Claude Design',
    heroTitleEmphasis: 'z dostępnym kodem źródłowym',
    heroTitleMiddle: 'na',
    ...
    faqSection: {
      ...
      titleMiddle: 'i',
      titleSuffix: 'alternatywę dla Claude Design z dostępnym kodem źródłowym',
    },
    cta: {
  ...
  id: homeFallbackCopy({
    ...
    faqSection: {
      ...
      titleMiddle: 'dan',
      titleSuffix: 'alternatif Claude Design dengan kode sumber tersedia',
    },
    cta: {
  ...
  nl: homeFallbackCopy({
    railRight: 'Open Design — deel 01 · nummer 26 · ODCL 1.0',
    ...
    heroLabel: 'Designstudio met beschikbare broncode',
    heroIssue: 'Case Nº 01 · lokaal / open / Aarde',
    heroTitlePrefix: 'Claude Design',
    heroTitleEmphasis: 'met beschikbare broncode',
    heroTitleMiddle: 'op',
    ...
    faqSection: {
      ...
      titleMiddle: 'en',
      titleSuffix: 'het Claude Design-alternatief met beschikbare broncode',
    },
    cta: {
  ...
  ar: homeFallbackCopy({
    railRight: 'Open Design — المجلد 01 · العدد 26 · ODCL 1.0',
    ...
    heroLabel: 'استوديو تصميم متاح المصدر',
    heroIssue: 'ملف Nº 01 · محلي / مفتوح / الأرض',
    heroTitlePrefix: 'Claude Design',
    heroTitleEmphasis: 'متاح المصدر',
    heroTitleMiddle: 'على',
    ...
    faqSection: {
      ...
      titleMiddle: 'و',
      titleSuffix: 'بديل Claude Design متاح المصدر',
    },
    cta: {
      rule: 'تواصل / محادثة',
  ...
  tr: homeFallbackCopy({
    railRight: 'Open Design — cilt 01 · sayı nº 26 · ODCL 1.0',
    railLeft: 'Skill · sistem · agent · BYOK · local-first',
    discordAria: 'Open Design Discord’a katıl',
    joinDiscord: 'Discord’a katıl',
    heroLabel: 'Kaynak kodu erişilebilir tasarım stüdyosu',
    heroIssue: 'Dosya Nº 01 · yerel / açık / Dünya',
    heroTitlePrefix: 'Claude Design',
    heroTitleEmphasis: 'kaynak kodu erişilebilir',
    heroTitleMiddle: '',
    ...
    faqSection: {
      ...
      titlePrefix: 'Sorular:',
      titleMiddle: 've',
      titleSuffix: 'Claude Design’ın kaynak kodu erişilebilir alternatifi',
    },
    cta: {
  ...
  uk: homeFallbackCopy({
    railRight: 'Open Design — том 01 · випуск № 26 · ODCL 1.0',
    ...
    heroLabel: 'Дизайн-студія з доступним вихідним кодом',
    heroIssue: 'Кейс № 01 · локально / відкрито / Земля',
    heroTitlePrefix: 'З доступним кодом',
    heroTitleEmphasis: 'Claude Design',
    ...
    faqSection: {
      ...
      titleMiddle: 'і',
      titleSuffix: 'альтернативу Claude Design з доступним вихідним кодом',
    },
    cta: {
