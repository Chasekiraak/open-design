...
export const fa: Dict = {
  ...
  'homeHero.designSystemGuide.add': 'افزودن سیستم طراحی',
  'homeHero.designSystemGuide.description': 'برای هماهنگ ماندن کار طراحی، در اینجا یک سیستم طراحی اضافه کنید.',
  'homeHero.designSystemGuide.taskHint': 'سیستم طراحی جزئیات بصری و مؤلفه‌ها را در این {task} هماهنگ نگه می‌دارد.',
  'homeHero.carousel.examplePrefix': 'نمونه پرامپت:',
