...
export const fa: Dict = {
  ...
  'settings.deckPromptVariantTitle': 'آزمایش قوانین Deck',
  'settings.deckPromptVariantDesc': 'قوانین اجرای عمومی بعدی Deck را انتخاب کنید. مهارت‌های Deck با قالب اختصاصی تغییر نمی‌کنند.',
  'settings.deckPromptVariantLabel': 'نسخه قوانین Deck',
  'settings.deckPromptVariantCurrent': 'V1 · چارچوب قبلی',
  'settings.deckPromptVariantCurrentOutcome': 'V2 · چارچوب قبلی + قوانین نتیجه',
