...
export const en: Dict = {
  ...
  'settings.deckPromptVariantTitle': 'Deck rules experiment',
  'settings.deckPromptVariantDesc': 'Choose the rules injected into the next generic Deck run. Deck skills with their own template seed are unchanged.',
  'settings.deckPromptVariantLabel': 'Deck rules version',
  'settings.deckPromptVariantCurrent': 'V1 · Legacy framework',
  'settings.deckPromptVariantCurrentOutcome': 'V2 · Legacy + outcome rules',
