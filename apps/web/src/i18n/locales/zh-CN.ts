...
export const zhCN: Dict = {
  ...
  "deliverable.title": "本次任务产物",
  "deliverable.view": "查看",
  "deliverable.preview": "预览",
  "deliverable.play": "播放",
  "deliverable.share": "分享",
  "deliverable.download": "下载",
  "deliverable.moreOutputs": "其他产物",
  "deliverable.filesChanged": "改动了 {count} 个文件",
  "deliverable.viewAllFiles": "查看本任务全部文件",
  "deliverable.kind.html": "网页",
  "deliverable.kind.presentation": "幻灯片",
  "deliverable.kind.pdf": "PDF",
  "deliverable.kind.document": "文档",
  "deliverable.kind.spreadsheet": "表格",
  "deliverable.kind.image": "图片",
  "deliverable.kind.video": "视频",
  "deliverable.kind.audio": "音频",
  "deliverable.kind.sketch": "草图",
  "deliverable.kind.code": "代码",
  "deliverable.kind.text": "文本",
  "deliverable.kind.binary": "文件",
  ...
  "qf.inspTabTemplates": "模板",
  "qf.inspTabDesignSystems": "设计系统",
  "qf.inspTabUpload": "我的图片",
  "qf.inspAll": "全部",
  "qf.inspBrowseAll": "浏览全部",
  "qf.inspUploadHint": "有参考的生成效果会好很多——选一个模板或设计系统，或上传 1–3 张你喜欢的图片。",
  "qf.inspUploadCta": "点击、拖入或粘贴图片",
  "qf.inspUploadLimit": "最多 {max} 张",
  "qf.inspEmpty": "暂无内容",
  "qf.inspLoading": "正在加载目录…",
  "qf.inspRemove": "移除",
  "qf.inspSearchDs": "搜索设计系统",
  "qf.inspSelectMultiple": "多选",
  "qf.inspClearSelection": "清除已选",
  "qf.inspCreateDs": "新建设计系统",
  "qf.inspYourDs": "你的设计系统",
  "qf.inspIncludedDs": "内置设计系统",
