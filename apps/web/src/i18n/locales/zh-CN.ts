...
export const zhCN: Dict = {
  ...
  "entry.creditsAria": "{tier} · 剩余积分",
  "entry.creditsAriaWithBalance": "{tier} · 剩余积分 {balance}",
  "entry.creditsGrantTip": "团队版按订阅额度发放积分，可在计费中查看用量。",
  ...
  'settings.mediaProviderModelProviders': '模型供应商',
  'settings.mediaProviderModel': '模型',
  'settings.mediaProviderModelPlaceholder': '使用提供商的默认模型',
  'settings.mediaProviderDocsTitle': '文档',
  'settings.mediaProviderDocsHint': '查看该 Provider 的 API Key、Model 和 Base URL 配置说明。',
  ...
  'community.title': '社区',
  'community.searchPlaceholder': '搜索插件…',
  'community.searchAria': '搜索模板',
