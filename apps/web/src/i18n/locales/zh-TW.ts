...
export const zhTW: Dict = {
  ...
  "entry.creditsAria": "{tier} · 剩餘積分",
  "entry.creditsAriaWithBalance": "{tier} · 剩餘積分 {balance}",
  "entry.creditsGrantTip": "團隊版按訂閱額度發放積分，可在計費中查看用量。",
  ...
  'settings.mediaProviderModelProviders': '模型供應商',
  'settings.mediaProviderModel': '模型',
  'settings.mediaProviderModelPlaceholder': '使用提供商的預設模型',
  'settings.mediaProviderDocsTitle': '文件',
  'settings.mediaProviderDocsHint': '查看該 Provider 的 API Key、Model 和 Base URL 設定說明。',
  ...
  'community.title': '社群',
  'community.searchPlaceholder': '搜尋外掛…',
  'community.searchAria': '搜尋範本',
