...
export const zhTW: Dict = {
  ...
  "homeHero.designSystemGuide.add": "添加設計系統",
  "homeHero.designSystemGuide.description": "在這裡添加設計系統，讓設計工作保持一致",
  "homeHero.designSystemGuide.taskHint": "為這個{task}添加設計系統，讓版面、色彩和元件保持一致。",
