...
export interface Dict {
  ...
  'deliverable.view': string;
  'deliverable.preview': string;
  'deliverable.play': string;
  'deliverable.share': string;
  'deliverable.download': string;
  'deliverable.moreOutputs': string;
  'deliverable.filesChanged': string;
  'deliverable.viewAllFiles': string;
  'deliverable.kind.html': string;
  'deliverable.kind.presentation': string;
  'deliverable.kind.pdf': string;
  'deliverable.kind.document': string;
  'deliverable.kind.spreadsheet': string;
  'deliverable.kind.image': string;
  'deliverable.kind.video': string;
  'deliverable.kind.audio': string;
  'deliverable.kind.sketch': string;
  'deliverable.kind.code': string;
  'deliverable.kind.text': string;
  'deliverable.kind.binary': string;
  ...
  'qf.inspTabTemplates': string;
  'qf.inspTabDesignSystems': string;
  'qf.inspTabUpload': string;
  'qf.inspAll': string;
  'qf.inspBrowseAll': string;
  'qf.inspUploadHint': string;
  'qf.inspUploadCta': string;
  'qf.inspUploadLimit': string;
  'qf.inspEmpty': string;
  'qf.inspLoading': string;
  'qf.inspRemove': string;
  'qf.inspSearchDs': string;
  'qf.inspSelectMultiple': string;
  'qf.inspClearSelection': string;
  'qf.inspCreateDs': string;
  'qf.inspYourDs': string;
  'qf.inspIncludedDs': string;
