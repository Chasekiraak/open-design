...
export interface Dict {
  ...
  // Codex CLI executable-path repair hints (shown after a connection test
  // when the saved CODEX_BIN path is unusable and a PATH fallback was used).
  'settings.codexPathRepairHint': string;
  'settings.codexPathUseDetected': string;
  'settings.codexPathClearCustom': string;
  'settings.codexPathConfiguredSuccess': string;
  'settings.codexPathInvalidFallback': string;
  'settings.codexPathFailedFallback': string;
  ...
  // Demo bilingual keys
  'demo.ChatPane.tsx.collapseChatRail'?: string;
  'demo.ChatPane.tsx.mockSenderQiongyuYou'?: string;
  'demo.ChatPane.tsx.mockSenderWeiZhang'?: string;
  'demo.ChatPane.tsx.mockSenderNaLi'?: string;
  'demo.ChatPane.tsx.mockSenderFangWang'?: string;
  'demo.ChatPane.tsx.mockSenderMingChen'?: string;
  'demo.ChatPane.tsx.mockSenderYangLiu'?: string;
  'demo.CreateTeamDialog.tsx.defaultTeamName'?: string;
  'demo.CreateTeamDialog.tsx.title'?: string;
  'demo.CreateTeamDialog.tsx.uploadLogo'?: string;
  'demo.CreateTeamDialog.tsx.subtitle'?: string;
  'demo.CreateTeamDialog.tsx.nameLabel'?: string;
  'demo.CreateTeamDialog.tsx.namePlaceholder'?: string;
  'demo.CreateTeamDialog.tsx.colorLabel'?: string;
  'demo.CreateTeamDialog.tsx.colorOption'?: string;
  'demo.CreateTeamDialog.tsx.cancel'?: string;
  'demo.CreateTeamDialog.tsx.create'?: string;
  'demo.CreditsPanel.tsx.upgrade'?: string;
  'demo.CreditsPanel.tsx.remainingCredits'?: string;
  'demo.CreditsPanel.tsx.viewUsage'?: string;
  'demo.CreditsPanel.tsx.insufficientCredits'?: string;
  'demo.CreditsPanel.tsx.memberNoticeBody'?: string;
  'demo.CreditsPanel.tsx.remindAdmin'?: string;
  'demo.DesignBrowserPanel.tsx.addImageToChatButton'?: string;
  'demo.DesignBrowserPanel.tsx.imageAddedToChat'?: string;
  'demo.DesignSystemPicker.tsx.readonlyProjectHint'?: string;
  'demo.DesignSystemsTab.tsx.convertToTeamDone'?: string;
  'demo.DesignSystemsTab.tsx.removeTeamSharingDone'?: string;
  'demo.DesignSystemsTab.tsx.expandSearch'?: string;
  'demo.DesignSystemsTab.tsx.removeTeamSharing'?: string;
  'demo.DesignSystemsTab.tsx.convertToTeamTitle'?: string;
  'demo.DesignSystemsTab.tsx.convertToTeam'?: string;
  'demo.EntryNavRail.tsx.accountAvatarInitial'?: string;
  'demo.EntryNavRail.tsx.accountName'?: string;
  'demo.EntryNavRail.tsx.upgrade'?: string;
  'demo.EntryNavRail.tsx.credits'?: string;
  'demo.EntryNavRail.tsx.bonusCredits'?: string;
  'demo.EntryNavRail.tsx.settings'?: string;
  'demo.EntryNavRail.tsx.getHelpOnGithub'?: string;
  'demo.EntryNavRail.tsx.submitFeatureRequest'?: string;
  'demo.EntryNavRail.tsx.joinDiscord'?: string;
  'demo.EntryNavRail.tsx.emailOpenDesign'?: string;
  'demo.EntryNavRail.tsx.addAccount'?: string;
  'demo.EntryNavRail.tsx.logOut'?: string;
  'demo.EntryNavRail.tsx.tooltipRecents'?: string;
  'demo.EntryNavRail.tsx.teamName'?: string;
  'demo.EntryNavRail.tsx.inviteColleagues'?: string;
  'demo.EntryNavRail.tsx.createTeam'?: string;
  'demo.EntryNavRail.tsx.tooltipDrafts'?: string;
  'demo.EntryNavRail.tsx.tooltipAllProjects'?: string;
  'demo.EntryNavRail.tsx.tooltipMembers'?: string;
  'demo.EntryNavRail.tsx.tooltipDashboard'?: string;
  'demo.EntryNavRail.tsx.tooltipWorkspaceSettings'?: string;
  'demo.EntryNavRail.tsx.contactEmailSubject'?: string;
  'demo.EntryNavRail.tsx.contactEmailBody'?: string;
  'demo.EntryShell.tsx.planNamePlus'?: string;
  'demo.EntryShell.tsx.planNameTeam'?: string;
  'demo.EntryShell.tsx.tierLabelTeam'?: string;
  'demo.EntryShell.tsx.planNameFree'?: string;
  'demo.EntryShell.tsx.tierLabelFree'?: string;
  'demo.EntryShell.tsx.grantTipPlus'?: string;
  'demo.EntryShell.tsx.grantTipPro'?: string;
  'demo.EntryShell.tsx.grantTipMax'?: string;
  'demo.EntryShell.tsx.grantTipTeam'?: string;
  'demo.EntryShell.tsx.grantTipFree'?: string;
  'demo.EntryShell.tsx.localModeTipAriaLabel'?: string;
  'demo.EntryShell.tsx.localModeTipCloseAriaLabel'?: string;
  'demo.EntryShell.tsx.localModeTipTitle'?: string;
  'demo.EntryShell.tsx.localModeTipBody'?: string;
  'demo.EntryShell.tsx.memberNameLina'?: string;
  'demo.EntryShell.tsx.celebrateUpgradeApplied'?: string;
  'demo.EntryShell.tsx.celebratePackCredited'?: string;
  'demo.EntryShell.tsx.celebrateJoinedTeam'?: string;
  'demo.EntryShell.tsx.inviteDeclinedToast'?: string;
  'demo.EntryShell.tsx.draftsHeading'?: string;
  'demo.EntryShell.tsx.draftsBlankTitle'?: string;
  'demo.EntryShell.tsx.draftsBlankDescription'?: string;
  'demo.EntryShell.tsx.allProjectsHeading'?: string;
  'demo.EntryShell.tsx.allProjectsBlankTitle'?: string;
  'demo.EntryShell.tsx.allProjectsBlankDescription'?: string;
  'demo.EntryShell.tsx.inviteBannerInviterName'?: string;
  'demo.EntryShell.tsx.inviteBannerMiddle'?: string;
  'demo.EntryShell.tsx.inviteBannerTeamName'?: string;
  'demo.EntryShell.tsx.inviteBannerSuffix'?: string;
  'demo.FileViewer.tsx.version.v4.title'?: string;
  'demo.FileViewer.tsx.version.v4.time'?: string;
  'demo.FileViewer.tsx.version.author.you'?: string;
  'demo.FileViewer.tsx.version.v4.source'?: string;
  'demo.FileViewer.tsx.version.v4.summary'?: string;
  'demo.FileViewer.tsx.version.v3.title'?: string;
  'demo.FileViewer.tsx.version.v3.time'?: string;
  'demo.FileViewer.tsx.version.v3.source'?: string;
  'demo.FileViewer.tsx.version.v3.summary'?: string;
  'demo.FileViewer.tsx.version.v2.title'?: string;
  'demo.FileViewer.tsx.version.v2.time'?: string;
  'demo.FileViewer.tsx.version.author.lina'?: string;
  'demo.FileViewer.tsx.version.v2.source'?: string;
  'demo.FileViewer.tsx.version.v2.summary'?: string;
  'demo.FileViewer.tsx.version.v1.title'?: string;
  'demo.FileViewer.tsx.version.v1.time'?: string;
  'demo.FileViewer.tsx.version.v1.source'?: string;
  'demo.FileViewer.tsx.version.v1.summary'?: string;
  'demo.FileViewer.tsx.viewerOnly.disabledTitle'?: string;
  'demo.FileViewer.tsx.viewerOnly.sendDisabledTitle'?: string;
  'demo.FileViewer.tsx.versionHistory'?: string;
  'demo.FileViewer.tsx.closeVersionHistory'?: string;
  'demo.FileViewer.tsx.versionPreview'?: string;
  'demo.FileViewer.tsx.shareExportActions'?: string;
  'demo.FileViewer.tsx.tab.share'?: string;
  'demo.FileViewer.tsx.tab.export'?: string;
  'demo.FileViewer.tsx.tab.send'?: string;
  'demo.FileViewer.tsx.cloudGuide.title'?: string;
  'demo.FileViewer.tsx.cloudGuide.desc'?: string;
  'demo.FileViewer.tsx.workspaceShare.title'?: string;
  'demo.FileViewer.tsx.workspaceShare.privateDesc'?: string;
  'demo.FileViewer.tsx.workspaceShare.workspaceDesc'?: string;
  'demo.FileViewer.tsx.access.private'?: string;
  'demo.FileViewer.tsx.access.workspace'?: string;
  'demo.FileViewer.tsx.publish.title'?: string;
  'demo.FileViewer.tsx.publish.desc'?: string;
  'demo.FileViewer.tsx.publish.copyLink'?: string;
  'demo.FileViewer.tsx.publish.unpublish'?: string;
  'demo.FileViewer.tsx.publish.publishFile'?: string;
  'demo.FileViewer.tsx.version.currentBadge'?: string;
  'demo.FileViewer.tsx.version.meta'?: string;
  'demo.FileViewer.tsx.version.restoredNote'?: string;
  'demo.FileViewer.tsx.version.restore'?: string;
  'demo.FileViewer.tsx.version.copiedNote'?: string;
  'demo.FileViewer.tsx.version.copyAsNew'?: string;
  'demo.FileWorkspace.tsx.readonlyNotice'?: string;
  'demo.FileWorkspace.tsx.collabActivityEditingLogo'?: string;
  'demo.FileWorkspace.tsx.collabActivityAdjustTypography'?: string;
  'demo.FileWorkspace.tsx.collabActivityCheckColorTokens'?: string;
  'demo.FileWorkspace.tsx.collabActivityConfirmLogo'?: string;
  'demo.FileWorkspace.tsx.collaboratorLina'?: string;
  'demo.FileWorkspace.tsx.collaboratorZhang'?: string;
  'demo.FileWorkspace.tsx.collaboratorWang'?: string;
  'demo.FileWorkspace.tsx.fileCollabLabelLinaHero'?: string;
  'demo.FileWorkspace.tsx.fileCollabLabelZhangCard'?: string;
  'demo.FileWorkspace.tsx.fileCollabLabelWangControls'?: string;
  'demo.FileWorkspace.tsx.fileCollabLabelLinaSpacing'?: string;
  'demo.HomeHero.tsx.workingDir'?: string;
  'demo.HomeHero.tsx.startBlankProject'?: string;
  'demo.HomeView.tsx.recentProjectsHeading'?: string;
  'demo.HomeView.tsx.baiduPresetName'?: string;
  'demo.HomeView.tsx.baiduPresetIdentity'?: string;
  'demo.InsufficientCreditsDialog.tsx.tier.plus.label'?: string;
  'demo.InsufficientCreditsDialog.tsx.tier.plus.desc'?: string;
  'demo.InsufficientCreditsDialog.tsx.tier.pro.label'?: string;
  'demo.InsufficientCreditsDialog.tsx.tier.pro.desc'?: string;
  'demo.InsufficientCreditsDialog.tsx.tier.max.label'?: string;
  'demo.InsufficientCreditsDialog.tsx.tier.max.desc'?: string;
  'demo.InsufficientCreditsDialog.tsx.tier.team.label'?: string;
  'demo.InsufficientCreditsDialog.tsx.tier.team.desc'?: string;
  'demo.InsufficientCreditsDialog.tsx.limit.30'?: string;
  'demo.InsufficientCreditsDialog.tsx.limit.50'?: string;
  'demo.InsufficientCreditsDialog.tsx.limit.100'?: string;
  'demo.InsufficientCreditsDialog.tsx.limit.200'?: string;
  'demo.InsufficientCreditsDialog.tsx.limit.custom'?: string;
  'demo.InsufficientCreditsDialog.tsx.limit.unlimited'?: string;
  'demo.InsufficientCreditsDialog.tsx.defaultMemberName'?: string;
  'demo.InsufficientCreditsDialog.tsx.dialogLabel'?: string;
  'demo.InsufficientCreditsDialog.tsx.close'?: string;
  'demo.InsufficientCreditsDialog.tsx.autoRechargeTitle'?: string;
  'demo.InsufficientCreditsDialog.tsx.creditsExhaustedTitle'?: string;
  'demo.InsufficientCreditsDialog.tsx.subtitleMember'?: string;
  'demo.InsufficientCreditsDialog.tsx.subtitleTeam'?: string;
  'demo.InsufficientCreditsDialog.tsx.subtitleUpgrade'?: string;
  'demo.InsufficientCreditsDialog.tsx.scopeLabel'?: string;
  'demo.InsufficientCreditsDialog.tsx.scopeMember'?: string;
  'demo.InsufficientCreditsDialog.tsx.scopeTeam'?: string;
  'demo.InsufficientCreditsDialog.tsx.paymentHint'?: string;
  'demo.InsufficientCreditsDialog.tsx.managePayment'?: string;
  'demo.InsufficientCreditsDialog.tsx.monthlyLimit'?: string;
  'demo.InsufficientCreditsDialog.tsx.billingCycle'?: string;
  'demo.InsufficientCreditsDialog.tsx.annual'?: string;
  'demo.InsufficientCreditsDialog.tsx.save20'?: string;
  'demo.InsufficientCreditsDialog.tsx.monthly'?: string;
  'demo.InsufficientCreditsDialog.tsx.perSeat'?: string;
  'demo.InsufficientCreditsDialog.tsx.perMonth'?: string;
  'demo.InsufficientCreditsDialog.tsx.prorateAnnual'?: string;
  'demo.InsufficientCreditsDialog.tsx.prorateMonthly'?: string;
  'demo.InsufficientCreditsDialog.tsx.prorateSuffix'?: string;
  'demo.InsufficientCreditsDialog.tsx.back'?: string;
  'demo.InsufficientCreditsDialog.tsx.cancel'?: string;
  'demo.InsufficientCreditsDialog.tsx.autoRechargeSaved'?: string;
  'demo.InsufficientCreditsDialog.tsx.save'?: string;
  'demo.InsufficientCreditsDialog.tsx.confirmUpgrade'?: string;
  'demo.InviteAcceptanceFlow.tsx.role.editor.label'?: string;
  'demo.InviteAcceptanceFlow.tsx.role.editor.en'?: string;
  'demo.InviteAcceptanceFlow.tsx.role.editor.perm'?: string;
  'demo.InviteAcceptanceFlow.tsx.role.admin.label'?: string;
  'demo.InviteAcceptanceFlow.tsx.role.admin.en'?: string;
  'demo.InviteAcceptanceFlow.tsx.role.admin.perm'?: string;
  'demo.InviteAcceptanceFlow.tsx.workspace.name'?: string;
  'demo.InviteAcceptanceFlow.tsx.workspace.inviter'?: string;
  'demo.InviteAcceptanceFlow.tsx.workspace.inviterInitial'?: string;
  'demo.InviteAcceptanceFlow.tsx.step.landing'?: string;
  'demo.InviteAcceptanceFlow.tsx.step.auth'?: string;
  'demo.InviteAcceptanceFlow.tsx.step.confirm'?: string;
  'demo.InviteAcceptanceFlow.tsx.step.joined'?: string;
  'demo.InviteAcceptanceFlow.tsx.step.declined'?: string;
  'demo.InviteAcceptanceFlow.tsx.stepper.aria'?: string;
  'demo.InviteAcceptanceFlow.tsx.dialog.aria'?: string;
  'demo.InviteAcceptanceFlow.tsx.dismiss.aria'?: string;
  'demo.InviteAcceptanceFlow.tsx.landing.fromMail'?: string;
  'demo.InviteAcceptanceFlow.tsx.landing.invitesYou'?: string;
  'demo.InviteAcceptanceFlow.tsx.landing.joinAsPrefix'?: string;
  'demo.InviteAcceptanceFlow.tsx.landing.joinAsSuffix'?: string;
  'demo.InviteAcceptanceFlow.tsx.landing.membersUnit'?: string;
  'demo.InviteAcceptanceFlow.tsx.landing.projectsUnit'?: string;
  'demo.InviteAcceptanceFlow.tsx.landing.accept'?: string;
  'demo.InviteAcceptanceFlow.tsx.landing.decline'?: string;
  'demo.InviteAcceptanceFlow.tsx.auth.title'?: string;
  'demo.InviteAcceptanceFlow.tsx.auth.sentToPrefix'?: string;
  'demo.InviteAcceptanceFlow.tsx.auth.sentToSuffix'?: string;
  'demo.InviteAcceptanceFlow.tsx.auth.tablistAria'?: string;
  'demo.InviteAcceptanceFlow.tsx.auth.tabLogin'?: string;
  'demo.InviteAcceptanceFlow.tsx.auth.tabRegister'?: string;
  'demo.InviteAcceptanceFlow.tsx.auth.nicknameLabel'?: string;
  'demo.InviteAcceptanceFlow.tsx.auth.nicknamePlaceholder'?: string;
  'demo.InviteAcceptanceFlow.tsx.auth.emailLabel'?: string;
  'demo.InviteAcceptanceFlow.tsx.auth.passwordLabel'?: string;
  'demo.InviteAcceptanceFlow.tsx.auth.passwordPlaceholderRegister'?: string;
  'demo.InviteAcceptanceFlow.tsx.auth.passwordPlaceholderLogin'?: string;
  'demo.InviteAcceptanceFlow.tsx.auth.submitRegister'?: string;
  'demo.InviteAcceptanceFlow.tsx.auth.submitLogin'?: string;
  'demo.InviteAcceptanceFlow.tsx.auth.back'?: string;
  'demo.InviteAcceptanceFlow.tsx.confirm.title'?: string;
  'demo.InviteAcceptanceFlow.tsx.confirm.rolePrefix'?: string;
  'demo.InviteAcceptanceFlow.tsx.confirm.roleSuffix'?: string;
  'demo.InviteAcceptanceFlow.tsx.confirm.seatNote'?: string;
  'demo.InviteAcceptanceFlow.tsx.confirm.join'?: string;
  'demo.InviteAcceptanceFlow.tsx.confirm.decline'?: string;
  'demo.InviteAcceptanceFlow.tsx.joined.titlePrefix'?: string;
  'demo.InviteAcceptanceFlow.tsx.joined.titleSuffix'?: string;
  'demo.InviteAcceptanceFlow.tsx.joined.subtitlePrefix'?: string;
  'demo.InviteAcceptanceFlow.tsx.joined.start'?: string;
  'demo.InviteAcceptanceFlow.tsx.declined.title'?: string;
  'demo.InviteAcceptanceFlow.tsx.declined.descPrefix'?: string;
  'demo.InviteAcceptanceFlow.tsx.declined.descPending'?: string;
  'demo.InviteAcceptanceFlow.tsx.declined.descSuffix'?: string;
  'demo.InviteAcceptanceFlow.tsx.declined.reconsider'?: string;
  'demo.InviteAcceptanceFlow.tsx.declined.close'?: string;
  'demo.InviteDialog.tsx.dialog-aria'?: string;
  'demo.InviteDialog.tsx.close'?: string;
  'demo.InviteDialog.tsx.title'?: string;
  'demo.InviteDialog.tsx.teamsize-free'?: string;
  'demo.InviteDialog.tsx.teamsize-team'?: string;
  'demo.InviteDialog.tsx.label-email'?: string;
  'demo.InviteDialog.tsx.assign-role'?: string;
  'demo.InviteDialog.tsx.default-role'?: string;
  'demo.InviteDialog.tsx.email-placeholder'?: string;
  'demo.InviteDialog.tsx.role-admin'?: string;
  'demo.InviteDialog.tsx.role-member'?: string;
  'demo.InviteDialog.tsx.role-viewer'?: string;
  'demo.InviteDialog.tsx.remove'?: string;
  'demo.InviteDialog.tsx.add-member'?: string;
  'demo.InviteDialog.tsx.visibility-toggle'?: string;
  'demo.InviteDialog.tsx.visibility-body'?: string;
  'demo.InviteDialog.tsx.submit'?: string;
  'demo.MembersView.tsx.title'?: string;
  'demo.MembersView.tsx.inviteBtn'?: string;
  'demo.MembersView.tsx.member.qy'?: string;
  'demo.MembersView.tsx.member.zw'?: string;
  'demo.MembersView.tsx.member.ln'?: string;
  'demo.MembersView.tsx.member.wf'?: string;
  'demo.MembersView.tsx.member.cm'?: string;
  'demo.MembersView.tsx.member.ly'?: string;
  'demo.MembersView.tsx.role.owner'?: string;
  'demo.MembersView.tsx.role.admin'?: string;
  'demo.MembersView.tsx.role.member'?: string;
  'demo.MembersView.tsx.creditPack.pro'?: string;
  'demo.MembersView.tsx.plan.baseFee'?: string;
  'demo.MembersView.tsx.plan.creditPack'?: string;
  'demo.MembersView.tsx.plan.assets'?: string;
  'demo.MembersView.tsx.plan.collab'?: string;
  'demo.MembersView.tsx.seats.label'?: string;
  'demo.MembersView.tsx.seats.used'?: string;
  'demo.MembersView.tsx.seats.perSeatMonth'?: string;
  'demo.MembersView.tsx.seats.perMonth'?: string;
  'demo.MembersView.tsx.seats.soloHint'?: string;
  'demo.MembersView.tsx.seats.soloSmall'?: string;
  'demo.MembersView.tsx.seats.teamSmall'?: string;
  'demo.MembersView.tsx.stepper.ariaLabel'?: string;
  'demo.MembersView.tsx.stepper.decrease'?: string;
  'demo.MembersView.tsx.stepper.increase'?: string;
  'demo.MembersView.tsx.stepper.seatCount'?: string;
  'demo.MembersView.tsx.autoRecharge.title'?: string;
  'demo.MembersView.tsx.autoRecharge.desc'?: string;
  'demo.MembersView.tsx.autoRecharge.btn'?: string;
  'demo.MembersView.tsx.col.person'?: string;
  'demo.MembersView.tsx.col.joined'?: string;
  'demo.MembersView.tsx.col.role'?: string;
  'demo.MembersView.tsx.youTag'?: string;
  'demo.MembersView.tsx.roleSelect.ariaLabel'?: string;
  'demo.MembersView.tsx.remove.ariaLabel'?: string;
  'demo.MembersView.tsx.remove.title'?: string;
  'demo.MembersView.tsx.pending.title'?: string;
  'demo.MembersView.tsx.pending.roleLabel'?: string;
  'demo.MembersView.tsx.pending.waiting'?: string;
  'demo.MembersView.tsx.pending.sent'?: string;
  'demo.MembersView.tsx.pending.resend'?: string;
  'demo.MembersView.tsx.toast.invitesSent'?: string;
  'demo.MembersView.tsx.toast.inviteResent'?: string;
  'demo.MembersView.tsx.toast.memberRemoved'?: string;
  'demo.MembersView.tsx.toast.upgraded'?: string;
  'demo.PluginMarketplaceDemo.tsx.source.official'?: string;
  'demo.PluginMarketplaceDemo.tsx.source.workspace'?: string;
  'demo.PluginMarketplaceDemo.tsx.source.personal'?: string;
  'demo.PluginMarketplaceDemo.tsx.source.all'?: string;
  'demo.PluginMarketplaceDemo.tsx.capability.connector'?: string;
  'demo.PluginMarketplaceDemo.tsx.capability.mcp'?: string;
  'demo.PluginMarketplaceDemo.tsx.capability.skill'?: string;
  'demo.PluginMarketplaceDemo.tsx.command.hint'?: string;
  'demo.PluginMarketplaceDemo.tsx.command.generate'?: string;
  'demo.PluginMarketplaceDemo.tsx.toast.shared'?: string;
  'demo.PluginMarketplaceDemo.tsx.toast.private'?: string;
  'demo.PluginMarketplaceDemo.tsx.hero.title'?: string;
  'demo.PluginMarketplaceDemo.tsx.hero.create'?: string;
  'demo.PluginMarketplaceDemo.tsx.tab.suites'?: string;
  'demo.PluginMarketplaceDemo.tsx.tab.skills'?: string;
  'demo.PluginMarketplaceDemo.tsx.badge.teamShared'?: string;
  'demo.PluginMarketplaceDemo.tsx.action.tryIt'?: string;
  'demo.PluginMarketplaceDemo.tsx.action.install'?: string;
  'demo.PluginMarketplaceDemo.tsx.menu.makePrivate'?: string;
  'demo.PluginMarketplaceDemo.tsx.menu.shareToTeam'?: string;
  'demo.PluginMarketplaceDemo.tsx.menu.uninstall'?: string;
  'demo.PluginMarketplaceDemo.tsx.create.title'?: string;
  'demo.PluginMarketplaceDemo.tsx.create.closeAria'?: string;
  'demo.PluginMarketplaceDemo.tsx.create.importFromLink'?: string;
  'demo.PluginMarketplaceDemo.tsx.create.importFromLinkDesc'?: string;
  'demo.PluginMarketplaceDemo.tsx.create.importUpload'?: string;
  'demo.PluginMarketplaceDemo.tsx.create.uploadFolder'?: string;
  'demo.PluginMarketplaceDemo.tsx.create.uploadFolderDesc'?: string;
  'demo.PluginMarketplaceDemo.tsx.create.pickFolder'?: string;
  'demo.PluginMarketplaceDemo.tsx.create.uploadKind'?: string;
  'demo.PluginMarketplaceDemo.tsx.create.term.suite'?: string;
  'demo.PluginMarketplaceDemo.tsx.create.term.skill'?: string;
  'demo.PluginMarketplaceDemo.tsx.detail.back'?: string;
  'demo.PluginMarketplaceDemo.tsx.detail.commands'?: string;
  'demo.PluginMarketplaceDemo.tsx.detail.connections'?: string;
  'demo.PluginMarketplaceDemo.tsx.detail.connectorStatusAria'?: string;
  'demo.PluginMarketplaceDemo.tsx.detail.noConnections'?: string;
  'demo.PluginMarketplaceDemo.tsx.detail.knowledgeSkills'?: string;
  'demo.PluginMarketplaceDemo.tsx.detail.noSkills'?: string;
  'demo.PluginMarketplaceDemo.tsx.skillDetail.closeAria'?: string;
  'demo.PluginMarketplaceDemo.tsx.skillDetail.use'?: string;
  'demo.PluginMarketplaceDemo.tsx.skillDetail.markdownNotice'?: string;
  'demo.ProjectView.tsx.person.zhangwei'?: string;
  'demo.ProjectView.tsx.person.zhangwei.initials'?: string;
  'demo.ProjectView.tsx.person.lina'?: string;
  'demo.ProjectView.tsx.person.lina.initials'?: string;
  'demo.ProjectView.tsx.person.wangfang'?: string;
  'demo.ProjectView.tsx.person.wangfang.initials'?: string;
  'demo.ProjectView.tsx.person.qiongyu'?: string;
  'demo.ProjectView.tsx.person.qiongyu.initials'?: string;
  'demo.ProjectView.tsx.presence.activity.commentingTypography'?: string;
  'demo.ProjectView.tsx.presence.activity.commentingLogo'?: string;
  'demo.ProjectView.tsx.presence.activity.viewingColorTokens'?: string;
  'demo.ProjectView.tsx.presence.ariaLabel'?: string;
  'demo.ProjectView.tsx.presence.avatarTitle'?: string;
  'demo.ProjectView.tsx.presence.moreOnline'?: string;
  'demo.ProjectView.tsx.presence.listAriaLabel'?: string;
  'demo.ProjectView.tsx.presence.heading'?: string;
  'demo.ProjectView.tsx.readonly.defaultOwner'?: string;
  'demo.ProjectView.tsx.readonly.copy'?: string;
  'demo.RecentProjectsStrip.tsx.heading'?: string;
  'demo.RecentProjectsStrip.tsx.invite'?: string;
  'demo.RecentProjectsStrip.tsx.multiSelect'?: string;
  'demo.RecentProjectsStrip.tsx.sort'?: string;
  'demo.RecentProjectsStrip.tsx.shared'?: string;
  'demo.RecentProjectsStrip.tsx.select'?: string;
  'demo.RecentProjectsStrip.tsx.deselect'?: string;
  'demo.RecentProjectsStrip.tsx.createdBy'?: string;
  'demo.RecentProjectsStrip.tsx.noMutationTitle'?: string;
  'demo.RecentProjectsStrip.tsx.selectedReadonlyTitle'?: string;
  'demo.RecentProjectsStrip.tsx.bulkToolbar'?: string;
  'demo.RecentProjectsStrip.tsx.selectedPrefix'?: string;
  'demo.RecentProjectsStrip.tsx.selectedSuffix'?: string;
  'demo.RecentProjectsStrip.tsx.moveToTeam'?: string;
  'demo.RecentProjectsStrip.tsx.moveToPersonal'?: string;
  'demo.RecentProjectsStrip.tsx.bulkDelete'?: string;
  'demo.RecentProjectsStrip.tsx.cancel'?: string;
  'demo.RecentProjectsStrip.tsx.deleteConfirm'?: string;
  'demo.RecentProjectsStrip.tsx.moveToTeamDesc.pre'?: string;
  'demo.RecentProjectsStrip.tsx.moveToTeamDesc.strong'?: string;
  'demo.RecentProjectsStrip.tsx.moveToTeamDesc.post'?: string;
  'demo.RecentProjectsStrip.tsx.moveToPersonalDesc.pre'?: string;
  'demo.RecentProjectsStrip.tsx.moveToPersonalDesc.strong'?: string;
  'demo.RecentProjectsStrip.tsx.moveToPersonalDesc.post'?: string;
  'demo.RecentProjectsStrip.tsx.dontRemind'?: string;
  'demo.RecentProjectsStrip.tsx.confirmMoveToTeam'?: string;
  'demo.RecentProjectsStrip.tsx.confirmMoveToPersonal'?: string;
  'demo.RecentProjectsStrip.tsx.ownerFilter.all'?: string;
  'demo.RecentProjectsStrip.tsx.ownerFilter.mine'?: string;
  'demo.RecentProjectsStrip.tsx.ownerFilter.others'?: string;
  'demo.RecentProjectsStrip.tsx.kindFilter.all'?: string;
  'demo.RecentProjectsStrip.tsx.kindFilter.prototype'?: string;
  'demo.RecentProjectsStrip.tsx.kindFilter.deck'?: string;
  'demo.RecentProjectsStrip.tsx.kindFilter.media'?: string;
  'demo.RecentProjectsStrip.tsx.kindFilter.other'?: string;
  'demo.RecentProjectsStrip.tsx.time.justNow'?: string;
  'demo.RecentProjectsStrip.tsx.time.min12'?: string;
  'demo.RecentProjectsStrip.tsx.time.hr1'?: string;
  'demo.RecentProjectsStrip.tsx.time.hr3'?: string;
  'demo.RecentProjectsStrip.tsx.time.yesterday'?: string;
  'demo.RecentProjectsStrip.tsx.time.day2'?: string;
  'demo.RecentProjectsStrip.tsx.time.lastWeek'?: string;
  'demo.RecentProjectsStrip.tsx.time.week3'?: string;
  'demo.RecentProjectsStrip.tsx.member.me.name'?: string;
  'demo.RecentProjectsStrip.tsx.member.me.initial'?: string;
  'demo.RecentProjectsStrip.tsx.member.zhangwei.name'?: string;
  'demo.RecentProjectsStrip.tsx.member.zhangwei.initial'?: string;
  'demo.RecentProjectsStrip.tsx.member.lina.name'?: string;
  'demo.RecentProjectsStrip.tsx.member.lina.initial'?: string;
  'demo.RecentProjectsStrip.tsx.member.wangfang.name'?: string;
  'demo.RecentProjectsStrip.tsx.member.wangfang.initial'?: string;
  'demo.RecentProjectsStrip.tsx.member.chenming.name'?: string;
  'demo.RecentProjectsStrip.tsx.member.chenming.initial'?: string;
  'demo.RecentProjectsStrip.tsx.member.liuyang.name'?: string;
  'demo.RecentProjectsStrip.tsx.member.liuyang.initial'?: string;
  'demo.SettingsDialog.tsx.generalTitle'?: string;
  'demo.SettingsDialog.tsx.generalSubtitle'?: string;
  'demo.SettingsDialog.tsx.providerZhipu'?: string;
  'demo.SettingsDialog.tsx.providerStepfun'?: string;
  'demo.SettingsDialog.tsx.providerCustom'?: string;
  'demo.SettingsDialog.tsx.backToHome'?: string;
  'demo.SettingsDialog.tsx.searchSettingsPlaceholder'?: string;
  'demo.SettingsDialog.tsx.navGroupPersonal'?: string;
  'demo.SettingsDialog.tsx.navGeneralTitle'?: string;
  'demo.SettingsDialog.tsx.navGeneralSub'?: string;
  'demo.SettingsDialog.tsx.themeLabel'?: string;
  'demo.SettingsDialog.tsx.systemPrefsTitle'?: string;
  'demo.SettingsDialog.tsx.systemPrefsHint'?: string;
  'demo.SettingsDialog.tsx.cloudCalloutTitle'?: string;
  'demo.SettingsDialog.tsx.cloudCalloutBodyExecution'?: string;
  'demo.SettingsDialog.tsx.signInRegister'?: string;
  'demo.SettingsDialog.tsx.modelProviders'?: string;
  'demo.SettingsDialog.tsx.connected'?: string;
  'demo.SettingsDialog.tsx.disconnected'?: string;
  'demo.SettingsDialog.tsx.cloudCalloutBodyMedia'?: string;
  'demo.SettingsDialog.tsx.docsCalloutBody'?: string;
  'demo.TeamDashboardView.tsx.title'?: string;
  'demo.TeamDashboardView.tsx.autoRecharge.ariaLabel'?: string;
  'demo.TeamDashboardView.tsx.autoRecharge.heading'?: string;
  'demo.TeamDashboardView.tsx.autoRecharge.body'?: string;
  'demo.TeamDashboardView.tsx.autoRecharge.cta'?: string;
  'demo.TeamDashboardView.tsx.hero.ariaLabel'?: string;
  'demo.TeamDashboardView.tsx.hero.team'?: string;
  'demo.TeamDashboardView.tsx.hero.subtitle'?: string;
  'demo.TeamDashboardView.tsx.hero.rangeAriaLabel'?: string;
  'demo.TeamDashboardView.tsx.hero.range'?: string;
  'demo.TeamDashboardView.tsx.credit.ariaLabel'?: string;
  'demo.TeamDashboardView.tsx.credit.headingAdmin'?: string;
  'demo.TeamDashboardView.tsx.credit.headingMember'?: string;
  'demo.TeamDashboardView.tsx.credit.remaining'?: string;
  'demo.TeamDashboardView.tsx.credit.usedThisCycle'?: string;
  'demo.TeamDashboardView.tsx.credit.recharge'?: string;
  'demo.TeamDashboardView.tsx.credit.remainingBalance'?: string;
  'demo.TeamDashboardView.tsx.credit.memberNote'?: string;
  'demo.TeamDashboardView.tsx.credit.remindAdmin'?: string;
  'demo.TeamDashboardView.tsx.creditStatus.sufficient'?: string;
  'demo.TeamDashboardView.tsx.creditStatus.normal'?: string;
  'demo.TeamDashboardView.tsx.creditStatus.low'?: string;
  'demo.TeamDashboardView.tsx.creditStatus.needRecharge'?: string;
  'demo.TeamDashboardView.tsx.token.ariaLabel'?: string;
  'demo.TeamDashboardView.tsx.token.heading'?: string;
  'demo.TeamDashboardView.tsx.stat.designs'?: string;
  'demo.TeamDashboardView.tsx.stat.designs.delta'?: string;
  'demo.TeamDashboardView.tsx.stat.designSystems'?: string;
  'demo.TeamDashboardView.tsx.stat.designSystems.delta'?: string;
  'demo.TeamDashboardView.tsx.stat.activeMembers'?: string;
  'demo.TeamDashboardView.tsx.stat.activeMembers.delta'?: string;
  'demo.TeamDashboardView.tsx.person.qiongyu'?: string;
  'demo.TeamDashboardView.tsx.person.zhangwei'?: string;
  'demo.TeamDashboardView.tsx.person.lina'?: string;
  'demo.TeamDashboardView.tsx.person.wangfang'?: string;
  'demo.UpgradeTeamDialog.tsx.creditPackPlus'?: string;
  'demo.UpgradeTeamDialog.tsx.creditPackPro'?: string;
  'demo.UpgradeTeamDialog.tsx.creditPackMax'?: string;
  'demo.UpgradeTeamDialog.tsx.hintPlus'?: string;
  'demo.UpgradeTeamDialog.tsx.hintPro'?: string;
  'demo.UpgradeTeamDialog.tsx.hintMax'?: string;
  'demo.UpgradeTeamDialog.tsx.benefit1'?: string;
  'demo.UpgradeTeamDialog.tsx.benefit2'?: string;
  'demo.UpgradeTeamDialog.tsx.benefit3'?: string;
  'demo.UpgradeTeamDialog.tsx.benefit4'?: string;
  'demo.UpgradeTeamDialog.tsx.ariaPurchaseSeats'?: string;
  'demo.UpgradeTeamDialog.tsx.ariaUpgradeTeam'?: string;
  'demo.UpgradeTeamDialog.tsx.close'?: string;
  'demo.UpgradeTeamDialog.tsx.titlePurchaseSeats'?: string;
  'demo.UpgradeTeamDialog.tsx.titleUpgrade'?: string;
  'demo.UpgradeTeamDialog.tsx.subtitlePurchaseSeats'?: string;
  'demo.UpgradeTeamDialog.tsx.subtitleUpgrade'?: string;
  'demo.UpgradeTeamDialog.tsx.ariaPricingRule'?: string;
  'demo.UpgradeTeamDialog.tsx.pricingRuleTitle'?: string;
  'demo.UpgradeTeamDialog.tsx.pricingRuleBase'?: string;
  'demo.UpgradeTeamDialog.tsx.pricingRuleToken'?: string;
  'demo.UpgradeTeamDialog.tsx.seatCount'?: string;
  'demo.UpgradeTeamDialog.tsx.ariaSeatStepper'?: string;
  'demo.UpgradeTeamDialog.tsx.decreaseSeats'?: string;
  'demo.UpgradeTeamDialog.tsx.increaseSeats'?: string;
  'demo.UpgradeTeamDialog.tsx.ariaPlans'?: string;
  'demo.UpgradeTeamDialog.tsx.recommended'?: string;
  'demo.UpgradeTeamDialog.tsx.perSeatPerMonth'?: string;
  'demo.UpgradeTeamDialog.tsx.planTotalSuffix'?: string;
  'demo.UpgradeTeamDialog.tsx.baseFeePlus'?: string;
  'demo.UpgradeTeamDialog.tsx.ariaBenefits'?: string;
  'demo.UpgradeTeamDialog.tsx.dismissPurchase'?: string;
  'demo.UpgradeTeamDialog.tsx.dismissUpgrade'?: string;
  'demo.UpgradeTeamDialog.tsx.confirmPay'?: string;
  'demo.UpgradeTeamDialog.tsx.confirmUpgrade'?: string;
  'demo.WorkspaceInviteFlow.tsx.role.member.label'?: string;
  'demo.WorkspaceInviteFlow.tsx.role.member.description'?: string;
  'demo.WorkspaceInviteFlow.tsx.page.ariaLabel'?: string;
  'demo.WorkspaceInviteFlow.tsx.header.eyebrow'?: string;
  'demo.WorkspaceInviteFlow.tsx.header.title'?: string;
  'demo.WorkspaceInviteFlow.tsx.header.role'?: string;
  'demo.WorkspaceInviteFlow.tsx.auth.heading'?: string;
  'demo.WorkspaceInviteFlow.tsx.auth.subtitle'?: string;
  'demo.WorkspaceInviteFlow.tsx.auth.continueGoogle'?: string;
  'demo.WorkspaceInviteFlow.tsx.auth.continueGithub'?: string;
  'demo.WorkspaceInviteFlow.tsx.auth.orEmail'?: string;
  'demo.WorkspaceInviteFlow.tsx.form.emailLabel'?: string;
  'demo.WorkspaceInviteFlow.tsx.form.passwordLabel'?: string;
  'demo.WorkspaceInviteFlow.tsx.form.passwordPlaceholder'?: string;
  'demo.WorkspaceInviteFlow.tsx.form.continue'?: string;
  'demo.WorkspaceInviteFlow.tsx.form.useEmailLogin'?: string;
  'demo.WorkspaceInviteFlow.tsx.confirm.heading'?: string;
  'demo.WorkspaceInviteFlow.tsx.confirm.subtitle'?: string;
  'demo.WorkspaceInviteFlow.tsx.confirm.action'?: string;
  'demo.WorkspaceInviteFlow.tsx.joining.heading'?: string;
  'demo.WorkspaceInviteFlow.tsx.joining.subtitle'?: string;
  'demo.WorkspaceInviteFlow.tsx.success.heading'?: string;
  'demo.WorkspaceInviteFlow.tsx.success.subtitle'?: string;
  'demo.WorkspaceInviteFlow.tsx.success.action'?: string;
  'demo.WorkspaceInviteFlow.tsx.success.opening'?: string;
  'demo.WorkspaceInviteFlow.tsx.download.title'?: string;
  'demo.WorkspaceInviteFlow.tsx.download.description'?: string;
  'demo.WorkspaceInviteFlow.tsx.download.started'?: string;
  'demo.WorkspaceInviteFlow.tsx.download.action'?: string;
  'demo.WorkspaceInviteFlow.tsx.download.retry'?: string;
  'demo.WorkspaceSettingsView.tsx.workspaceName'?: string;
  'demo.WorkspaceSettingsView.tsx.toastDeleteTriggered'?: string;
  'demo.WorkspaceSettingsView.tsx.title'?: string;
  'demo.WorkspaceSettingsView.tsx.basicInfoAria'?: string;
  'demo.WorkspaceSettingsView.tsx.nameLabel'?: string;
  'demo.WorkspaceSettingsView.tsx.nameHint'?: string;
  'demo.WorkspaceSettingsView.tsx.iconLabel'?: string;
  'demo.WorkspaceSettingsView.tsx.iconHint'?: string;
  'demo.WorkspaceSettingsView.tsx.changeIcon'?: string;
  'demo.WorkspaceSettingsView.tsx.dangerZoneAria'?: string;
  'demo.WorkspaceSettingsView.tsx.dangerZoneTitle'?: string;
  'demo.WorkspaceSettingsView.tsx.dangerZoneDesc'?: string;
  'demo.WorkspaceSettingsView.tsx.deleteWorkspace'?: string;
  'demo.WorkspaceSettingsView.tsx.deleteModalTitle'?: string;
  'demo.WorkspaceSettingsView.tsx.close'?: string;
  'demo.WorkspaceSettingsView.tsx.subscriptionActiveTitle'?: string;
  'demo.WorkspaceSettingsView.tsx.subscriptionActiveDesc'?: string;
  'demo.WorkspaceSettingsView.tsx.notNow'?: string;
  'demo.WorkspaceSettingsView.tsx.toastSubscriptionCancelled'?: string;
  'demo.WorkspaceSettingsView.tsx.cancelSubscriptionFirst'?: string;
  'demo.WorkspaceSettingsView.tsx.confirmPrefix'?: string;
  'demo.WorkspaceSettingsView.tsx.confirmSuffix'?: string;
  'demo.WorkspaceSettingsView.tsx.confirmNameAria'?: string;
  'demo.WorkspaceSettingsView.tsx.cancel'?: string;
  'demo.WorkspaceSettingsView.tsx.confirmDelete'?: string;
  'demo.WorkspaceTabsBar.tsx.radialHome'?: string;
  'demo.WorkspaceTabsBar.tsx.radialAllProjects'?: string;
  'demo.WorkspaceTabsBar.tsx.radialDesignSystems'?: string;
  'demo.WorkspaceTabsBar.tsx.radialCommunity'?: string;
  'demo.WorkspaceTabsBar.tsx.railToggleLabel'?: string;
  'demo.WorkspaceTabsBar.tsx.railToggleTooltip'?: string;
  'demo.WorkspaceTabsBar.tsx.entryDrafts'?: string;
  'demo.WorkspaceTabsBar.tsx.entryAllProjects'?: string;
  'demo.WorkspaceTabsBar.tsx.entryContentPlan'?: string;
  'demo.WorkspaceTabsBar.tsx.entryMembers'?: string;
  'demo.WorkspaceTabsBar.tsx.entryDashboard'?: string;
  'demo.WorkspaceTabsBar.tsx.entryWorkspaceSettings'?: string;
  'demo.PluginCard.tsx.visibility-shared'?: string;
  'demo.PluginCard.tsx.visibility-private'?: string;
  'demo.PluginCard.tsx.set-private'?: string;
  'demo.PluginCard.tsx.share-to-team'?: string;
  'demo.PluginCard.tsx.set-private-aria'?: string;
  'demo.PluginCard.tsx.share-to-team-aria'?: string;
}
