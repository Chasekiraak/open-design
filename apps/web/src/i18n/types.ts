...
export interface Dict {
  ...
  'homeHero.designSystemGuide.add': string;
  'homeHero.designSystemGuide.description': string;
  'homeHero.designSystemGuide.taskHint': string;
  'homeHero.carousel.examplePrefix': string;
