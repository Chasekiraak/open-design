...
const BUILD_COMMANDS = [
  ...
  { args: ["--filter", "@open-design/distribution-proto", "build"] },
...
function workspaceBuildOutputFiles(config: ToolPackConfig): string[] {
  ...
  return [
    ...
    "packages/distribution-proto/dist/index.mjs",
    "packages/distribution-proto/dist/index.d.ts",
...
function workspaceBuildArtifacts(config: ToolPackConfig): WorkspaceBuildArtifact[] {
  const artifacts = [
    ...
    "packages/distribution-proto/dist",
